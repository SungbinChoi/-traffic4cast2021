...
target_city   = 'NEWYORK'        # 'BERLIN' 'CHICAGO' 'ISTANBUL' 'MELBOURNE'             'NEWYORK'  'VIENNA'                          
load_model_id = 't2m4'                                                                 
load_model_path  = '../trained_models/' + load_model_id + '.pth'
input_test_data_filepath = '../../0_data/' + target_city + '/' + target_city + '_test_spatiotemporal.h5'           
test_save_folder_path = '../test_runs/' + load_model_id + '/' + target_city
test_save_filepath = test_save_folder_path + '/' + target_city + '_test_spatiotemporal.h5'
