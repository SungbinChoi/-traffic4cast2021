...
if __name__ == '__main__':
  ...
  if shuffle_dr > 0:
    ...
    static_data_shuffled = static_data.copy()
    test_data_shuffled[:,:,:,:,shuffle_dr*2:]  = test_data[:,:,:,:,0:8-shuffle_dr*2]
    test_data_shuffled[:,:,:,:,0:shuffle_dr*2] = test_data[:,:,:,:,8-shuffle_dr*2:]
    static_data_shuffled[:,1+shuffle_dr*2:,     :,:] = static_data[:,1+0:1+(8-shuffle_dr*2),  :,:]
    static_data_shuffled[:,1+0:1+shuffle_dr*2,  :,:] = static_data[:,1+(8-shuffle_dr*2):,     :,:]
    test_data   = test_data_shuffled
    static_data = static_data_shuffled     
  ...
  if shuffle_dr > 0:
    prediction_list_shuffled   = prediction_list.copy()
    prediction_list_shuffled[:,:,:,:,shuffle_dr*2:]  = prediction_list[:,:,:,:,0:8-shuffle_dr*2]
    prediction_list_shuffled[:,:,:,:,0:shuffle_dr*2] = prediction_list[:,:,:,:,8-shuffle_dr*2:]
    prediction_list   = prediction_list_shuffled  
